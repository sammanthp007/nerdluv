...
<input type="text" name="name" size="17" maxlength="16"><br><br>
    ...
    <strong class="column">Age:</strong><input type="text" name="age" size="6" maxlength="2"><br><br>
    <strong class="column">Personality Type:</strong><input type="text" name="personality_type" size="6" maxlength="4"><br><br>
